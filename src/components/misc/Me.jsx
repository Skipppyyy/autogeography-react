        ...
        <div name="me" className="me">
            <div className="container"> 
                ...
                <div className="textbox">
                    ...
                    <p></p>
                    <br></br>
                    <h3>Yet, the new age of technology hides a competitive undercurrent, especially for students. As humans, we first become susceptible to social influence when we reach adolescence (Imogen). For many of my peers and I, being surrounded by overwhelming amounts of success meant an enormous pressure to excel. As a result, while we would watch films glamorizing a traditional adolescence full of social and personal exploration, we lived in a reality that was dominated by academic pressure. Entering high school, I noticed that for many of my peers, learning had become more about competition–earning the highest homework and test scores–than genuine curiosity, something I that sadly still observe in college. This unhealthy competition has generally led to many consequences, sometimes severe. 
                    </h3>
                </div>
            </div>
        </div>
